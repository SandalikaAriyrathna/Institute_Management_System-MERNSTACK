...
export default function RegisterModel(props) {
  ...
  //   axios.post('http://localhost:5000/api/AcStaffAuth/register', staffData)
...
<br></br>
  ...
  <Form.Group as={Row} className="mb-3" controlId="formPlaintextPassword">
    ...
    <Col sm="7">
      <Form.Control   type="tel" placeholder="Enter your User Name" maxLength="10"  required />
    </Col>
  </Form.Group>
  ...
  <Form.Group as={Row} className="mb-3" controlId="formPlaintextPassword">
    ...
    <Col sm="7">
      <Form.Control   type="tel" placeholder="Enter your Password" maxLength="10"  required />
    </Col>
  </Form.Group>
  </Col>
</Form>
