...
export default function PhysicalDeleteFees(props) {
  ...
  const handleDelete = async (e)=> {
    console.log(id)
   await axios.delete(`http://localhost:5000/api/PhysicalFeeses/${id}`,payment)
  ...
  <Col sm="7">
    <Form.Control  value={monthly_fee} type="number"  readonly />
      ...
      <Modal.Footer>
        ...
        <Button variant="danger" onClick={handleDelete} style={{width:"20%"}}>
            Delete
          </Button>
